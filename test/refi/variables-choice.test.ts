...
Deno.test("VariableValue choice: each type and invalid multi-choice", () => {
  const base: ProjectJson = {
    ...
    Variables: {
      Variable: [
        { _attributes: { guid: "aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa", name: "v-text", typeOfVariable: "Text" } },
        { _attributes: { guid: "bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb", name: "v-bool", typeOfVariable: "Boolean" } },
        { _attributes: { guid: "cccccccc-cccc-cccc-cccc-cccccccccccc", name: "v-int", typeOfVariable: "Integer" } },
        { _attributes: { guid: "dddddddd-dddd-dddd-dddd-dddddddddddd", name: "v-float", typeOfVariable: "Float" } },
        { _attributes: { guid: "eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee", name: "v-date", typeOfVariable: "Date" } },
        {
          _attributes: { guid: "ffffffff-ffff-ffff-ffff-ffffffffffff", name: "v-datetime", typeOfVariable: "DateTime" },
        },
      ],
    },
    Sources: {
